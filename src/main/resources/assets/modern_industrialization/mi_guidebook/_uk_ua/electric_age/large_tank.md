...
Великий бак — це багатоблок, який дозволяє зберігати велику кількість рідини, наприклад пари. Він може зберігати 64 відра рідини для кожного блока конструкції (включно зі сторонами).
...
Лише труби можуть отримати доступ до баку через контролер або через шлюз великого бака (див. наступну сторінку).

Не ламайте контролер, інакше ви втратите всю рідину, що зберігається!

Шлюз великого баку діє як розширення блоку великого баку. Ви можете натиснути на нього ПКМ, щоб відкрити меню великого бака, і труби, приєднані до нього, отримають прямий доступ до нього.
