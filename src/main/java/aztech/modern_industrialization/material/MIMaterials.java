...
public class MIMaterials {
    ...
    public static MIMaterial aluminum = new MIMaterial("aluminum", false).addItemType(new String [] { "crushed_dust","curved_plate","double_ingot","dust","ingot","large_plate","nugget","plate","small_dust"}).addBlockType(new String [] { "block","machine_casing" });
    ...
    public static MIMaterial battery_alloy = new MIMaterial("battery_alloy", false).addItemType(new String [] { "curved_plate","double_ingot","dust","ingot","nugget","plate","small_dust"}).addBlockType(new String [] { "block" });
    ...
    public static MIMaterial bronze = new MIMaterial("bronze", false).addItemType(new String [] { "blade","bolt","curved_plate","double_ingot","dust","gear","ingot","large_plate","nugget","plate","ring","rod","rotor","small_dust"}).addBlockType(new String [] { "block","machine_casing" });
    ...
    public static MIMaterial cupronickel = new MIMaterial("cupronickel", false).addItemType(new String [] { "double_ingot","dust","ingot","nugget","plate","small_dust","wire"}).addBlockType(new String [] { "block","coil" });
    ...
    public static MIMaterial invar = new MIMaterial("invar", false).addItemType(new String [] { "double_ingot","dust","gear","ingot","large_plate","nugget","plate","small_dust"}).addBlockType(new String [] { "block","machine_casing" });
    ...
    public static MIMaterial redstone = new MIMaterial("redstone", false).addItemType(new String [] { "crushed_dust"});
    ...
    public static MIMaterial steel = new MIMaterial("steel", false).addItemType(new String [] { "blade","bolt","curved_plate","double_ingot","dust","gear","ingot","large_plate","nugget","plate","ring","rod","rotor","small_dust"}).addBlockType(new String [] { "block","machine_casing" });
