...
public class MIMaterials {
    ...
    public static MIMaterial lignite_coal = new MIMaterial("lignite_coal", false).addItemType(new String [] { "crushed_dust","dust","lignite_coal"}).addBlockType(new String [] { "ore" }).setupOreGenerator(20, 17, 128);
