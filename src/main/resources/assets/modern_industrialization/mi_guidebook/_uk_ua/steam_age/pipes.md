...
Предметні труби не приєднуватимуться до інвентарю усталено, але знову ж таки ви можете примусово встановити з'єднання.

ПКМ для приєднання, не тримаючи гайкового ключа, і ви побачите фільтр. Усталено режим білого списку ввімкнено, тому жодні предмети не вставлятимуться чи витягуватимуться безпосередньо.
